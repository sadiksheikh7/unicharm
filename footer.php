          ...
          <ul class="custom-search-list">
              <li>
                <a href="retailers.php">	
                  <div class="list-icon"><i class="fa fa-bars"></i></div>
                  <div class="search-list-text">
                    <p>Retailers <code>></code> Retailers</p>
                    <small>Menu</small>
                  </div>
                </a>
              </li>
              ...
              <li>
                <a href="#" data-toggle="modal" data-target="#importRetailer">	
                  <div class="list-icon"><i class="fa fa-bars"></i></div>
                  <div class="search-list-text">
                    <p>Retailers <code>></code> Import Retailers</p>
                    <small>Menu</small>
                  </div>
                </a>
              </li>
              ...
              <li>
                <a href="ledger.php">	
                  <div class="list-icon"><i class="fa fa-bars"></i></div>
                  <div class="search-list-text">
                     <p>Accounts <code>></code> Purchases A/C</p>
                    <small>Menu</small>
                  </div>
                </a>
              </li>
              <li>
                <a href="purchase-receipt.php">	
                  <div class="list-icon"><i class="fa fa-bars"></i></div>
                  <div class="search-list-text">
                    <p>Accounts <code>></code> Purchase Receipt</p>
                    <small>Menu</small>
                  </div>
                </a>
              </li>
              ...
              <li>
                <a href="javascript:void(0)">
                  Accounts <code>></code> Purchase Payment
                </a>
              </li>
              <li>
                <a href="javascript:void(0)">
                  Accounts <code>></code> Purchase Return
                </a>
              </li>
              ...
              <li>
                <a href="invoice.php">
                  Billing <code>></code> Invoices
                </a>
              </li>
              <li>
                <a href="create-invoice.php">
                  Billing <code>></code> Create Invoice
                </a>
              </li>
              <li>
                <a href="javascript:void(0)">
                  Billing <code>></code> Billing Setting
                </a>
              </li>
            ...
            <li>
              <a href="index.php">
                Menus <code>></code> Dashboard
              </a>
            </li>
            <li>
              <a href="products.php">
                Menus <code>></code> Products
              </a>
            </li>
            <li>
              <a href="javascript:void(0)">
                Menus <code>></code> Inventory
              </a>
            </li>
            <li>
              <a data-toggle="modal" data-target="#AccountSetting" href="javascript:void(0)">  
                Menus <code>></code> Company
              </a>
            </li>
            <li class="nav-item active">
              <a href="manage-user.php">
                Menus <code>></code> Manage User
              </a>
            </li>
            <li>
              <a href="javascript:void(0)">
                Menus <code>></code> Taxes
              </a>
            </li>
            <li>
              <a href="javascript:void(0)">
                Menus <code>></code> Financial Year
              </a>
            </li>
            <li>
              <a href="javascript:void(0)">
                Menus <code>></code> Claim
              </a>
            </li>
            <li>
              <a href="javascript:void(0)">
                Menus <code>></code> Settings
              </a>
            </li>
            <li>
              <a href="reports.php">
                Menus <code>></code> Reports
              </a>
            </li>


              <li><a href="retailers.php">Retailers</a></li>
              <li><a href="">General <code>></code> Sales man</a></li>
              <li><a href="">General <code>></code> User/Team</a></li>
              <li><a href="">General <code>></code> Company</a></li>



              <li><a href="">Analysis <code>></code> Dashboard</a></li>
              <li><a href="">Analysis <code>></code> Reports</a></li>
              <li><a href="">Analysis <code>></code> Audit Log</a></li>
              <li><a href="">Analysis <code>></code> P&amp;L Trial Balance</a></li>
              <li><a href="">Analysis <code>></code> Products Expenses</a></li>


              <li><a href="">Invoice <code>></code> Invoice Management</a></li>
              <li><a href="">Invoice <code>></code> Purchase Management</a></li>
              <li><a href="">Invoice <code>></code> New&nbsp;Invoice</a></li>
              <li><a href="">Invoice <code>></code> Purchase Bill</a></li>
              <li><a href="">Invoice <code>></code> Purchase Receipt</a></li>
              <li><a href="">Invoice <code>></code> Credit Note</a></li>
              <li><a href="">Invoice <code>></code> Debit Note</a></li>



              <li><a href="">Profile <code>></code> Feedback</a></li>
              <li><a href="">Profile <code>></code> Privacy</a></li>
              <li><a href="">Profile <code>></code> Suggestion&nbsp;</a></li>
              <li><a href="">Profile <code>></code> Setting</a></li>
              <li><a href="">Profile <code>></code> Support</a></li>
              <li><a href="">Profile <code>></code> Live chat</a></li>


              <li><a href="">Other <code>></code> GSTR</a></li>
              <li><a href="">Other <code>></code> Inventory</a></li>
              <li><a href="">Other <code>></code> About Unicharm's </a></li>
              <li><a href="">Other <code>></code> Unicharm's Website&nbsp;&nbsp;</a></li>


              <li><a href="">Security <code>></code> Import Data</a></li>
              <li><a href="">Security <code>></code> Permission</a></li>
              <li><a href="">Security <code>></code> Integration</a></li>

              <li><a href="javascript:void(0)">Business overview <code>></code> Audit Log</a></li>
              <li><a href="javascript:void(0)">Business overview <code>></code> Business Snapshot</a></li>
              <li><a href="javascript:void(0)">Business overview <code>></code> Retailers Report</a></li>


              <li><a href="javascript:void(0)">Sales <code>></code> Total Sales Report</a></li>
              <li><a href="javascript:void(0)">Sales <code>></code> Sales by Retailers</a></li>
              <li><a href="javascript:void(0)">Sales <code>></code> Sales by Product</a></li>
              <li><a href="javascript:void(0)">Sales <code>></code> Monthly Sales</a></li>


              <li><a href="javascript:void(0)">Purchases <code>></code> Total Purchases Report </a></li>
              <li><a href="javascript:void(0)">Purchases <code>></code> Purchases by Item</a></li>
              <li><a href="javascript:void(0)">Purchases <code>></code> Monthly Purchases</a></li>

              <li><a href="javascript:void(0)">Inventory <code>></code> Total Inventory Report</a></li>
              <li><a href="javascript:void(0)">Inventory <code>></code> Monthly Inventory Report</a></li>
              <li><a href="javascript:void(0)">Inventory <code>></code> Inventory Snapshot</a></li>

              <li><a href="javascript:void(0)">Claim <code>></code> Total Inventory Report</a></li>
